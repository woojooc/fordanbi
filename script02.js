...
const translations = {
  ...
  ko: {
    ...
    story3:
      "하지만 종양은 제거해도 다시 자라나게 되었고, 또 다시 더 크게 자라나는 상황이 반복될 것이라고 합니다",
...
function initializePayPal() {
  ...
  const overlay =
    document.querySelector(".paypal-modal-overlay");

  const container =
    document.getElementById("paypal-button-container");

  const modalAmount =
    document.getElementById("paypalModalAmount"); 
    ...
    async function(event) {
      ...
      */
      ...
      try {
        ...
        const amountUSD =
          paypalDonationAmounts[amountKRW];
      ...
      <div class="paypal-modal-overlay">
        ...
        >
          ...
          <div class="paypal-modal-header">
            ...
            <div class="paypal-modal-icon">
              🌎
            </div>

            <h2 id="paypalModalTitle">
              PayPal 후원
            </h2>
